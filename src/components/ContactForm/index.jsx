    ...
    >
      ...
      <div>
        ...
        <input
          type="text"
          {...register("name")}
          className="mt-1 w-full ring-blue-300 border-blue-300 rounded-md shadow-sm p-1 focus:ring-blue-400 focus:border-blue-400"
        />
        {errors.name && (
      ...
      <div>
        ...
        <textarea
          rows={10}
          {...register("message")}
          className="resize-none mt-1 w-full ring-blue-300 border-blue-300 rounded-md shadow-sm p-1 focus:ring-blue-400 focus:border-blue-400"
        />
        {errors.message && (
